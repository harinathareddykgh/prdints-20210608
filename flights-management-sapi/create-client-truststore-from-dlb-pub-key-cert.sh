...
DLB=tngaa-nonprod-public # non-prod DLB name
PUBCERT="src/test/resources/certs/$DLB-pub-key-cert.pem"
TRUSTSTORE="src/main/resources/certs/$DLB-client-trust.p12"
